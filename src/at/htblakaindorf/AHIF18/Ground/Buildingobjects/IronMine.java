...
/**
 * <b>CityBuild</b><br>
 * Specified {@link Building} class for the {@link IronMine}
 *
...
public class IronMine extends Building {
    ...
    public IronMine(String name, boolean collision, int id, boolean building, int[] costs, int[] earnings, int col, int row) {
