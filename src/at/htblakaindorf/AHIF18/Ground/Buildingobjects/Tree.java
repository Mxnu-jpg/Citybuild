...
/**
 * <b>CityBuild</b><br>
 * Specified {@link Building} class for the {@link Tree}
 *
...
public class Tree extends Building {
    ...
    public Tree(String name, boolean collision, int id, boolean building, int[] costs, int[] earnings, int col, int row) {
